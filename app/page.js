...
export default function Home() {
  let text = "passionate about changing the world with technology";
  ...
  useEffect(() => {
    ...
    }, 300); // Adjust the typing speed here (milliseconds)
  ...
  useEffect(() => {
    ...
    }, 3000); // Change color every 1 second
  ...
  return (<>
   ...
   <main className={styles.main}>
    ...
    <div className={styles.container} style={{ backgroundColor }}>
      <h1 className= {styles.centeredHeading}>Mayank Sharma</h1>
